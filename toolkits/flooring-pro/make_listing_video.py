...
TAGLINE = "LVP · Tile · Hardwood · Carpet · Vinyl"

# Inputs that "type in" during phase 2
INPUT_ROWS = [
    ("Material",         "LVP"),
    ("Total area",       "1,036 sq ft"),
    ("Waste factor",     "10%"),
    ("Box coverage",     "23.45 sf/box"),
    ("Tear-out",         "Yes"),
    ("Transitions",      "13 LF"),
]
...
RESULT_ROWS = [
    ("MATERIAL SF",     "1,140 sq ft"),
    ("BOXES",           "49 boxes"),
    ("UNDERLAYMENT",    "1,036 sq ft"),
    ("LABOR HOURS",     "85 hours"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$12,371"
