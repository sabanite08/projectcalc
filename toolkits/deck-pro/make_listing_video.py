...
TAGLINE = "Joists · Footings · Boards · Railing · Quote"

# Inputs that "type in" during phase 2
INPUT_ROWS = [
    ("Deck size",       "16 x 12 ft"),
...
RESULT_ROWS = [
    ("JOISTS",          "10 joists (170 LF)"),
    ("CONCRETE",        "0.8 CY"),
    ("DECKING BOARDS",  "31 boards"),
    ("LABOR HOURS",     "56 hours"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$10,634"
