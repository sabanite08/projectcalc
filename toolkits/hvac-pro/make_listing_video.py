...
TAGLINE = "Manual J · Duct CFM · ASHRAE 62.2 · Quote"
...
RESULT_ROWS = [
    ("HEATING LOAD",  "23,066 BTU/h"),
    ("COOLING LOAD",  "28,290 BTU/h"),
    ("EQUIPMENT",     "2.5 ton heat pump"),
    ("TOTAL DUCT CFM","1,000 CFM"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$11,810"
