"""Generate Etsy listing video for Roofing Pro Toolkit.
...
TAGLINE = "Material takeoff · Ventilation NFA · Customer quote"
...
INPUT_ROWS = [
    ...
    ("Roof pitch",         "6/12"),
    ("Ridge length",       "50 ft"),
    ("Eave (drip edge)",   "100 ft"),
    ("Shingle type",       "Architectural"),
]

# Results that animate in during phase 3
RESULT_ROWS = [
    ("ROOF AREA",      "1,860 sq ft"),
    ("SQUARES",        "18.6 (10% waste)"),
    ("BUNDLES",        "62 architectural"),
    ("RIDGE CAP",      "2 bundles"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$8,157"
