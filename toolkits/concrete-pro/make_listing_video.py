"""Generate Etsy listing video for Concrete Pro Toolkit.
...
TAGLINE = "Yardage · Rebar · Forms · Customer quote"
...
RESULT_ROWS = [
    ("SLAB",          "16.00 cu yd"),
    ("FOOTINGS",      "3.50 cu yd"),
    ("REBAR (slab)",  "98 sticks"),
    ("REBAR (foot)",  "9 sticks"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$19,490"
