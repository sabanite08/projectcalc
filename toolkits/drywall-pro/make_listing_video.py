...
TAGLINE = "Sheets · Mud · Tape · Screws · GA-214 Quote"

# Inputs that "type in" during phase 2
INPUT_ROWS = [
    ("Rooms",            "10 rooms"),
    ("Ceiling height",   "9 ft"),
    ("Finish level",     "GA-214 L4"),
    ("Sheet size",       "4 × 8 ft"),
    ("Waste factor",     "10%"),
    ("Outside corners",  "80 LF"),
]

# Results that animate in during phase 3
RESULT_ROWS = [
    ('1/2" SHEETS',     "188 sheets"),
    ('5/8" TYPE X',     "31 sheets"),
    ("JOINT COMPOUND",  "336 gallons"),
    ("LABOR HOURS",     "232 hours"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$22,805"
