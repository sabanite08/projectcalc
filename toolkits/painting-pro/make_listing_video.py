"""Generate Etsy listing video for HVAC Pro Toolkit.
...
# ──────────────────────────────────────────────────────────────────────
# CONTENT (Painting) — change these to make a video for another tk
# ──────────────────────────────────────────────────────────────────────
...
TAGLINE = "Room takeoff · Gallons · Labor hours · Quote"
...
INPUT_ROWS = [
    ...
    ("Trim coats",       "2 coats"),
    ("Prep level",       "Level 2"),
    ("Texture factor",   "1.00 smooth"),
]

# Results that animate in during phase 3
RESULT_ROWS = [
    ("WALL SQ FT",      "2,898 sq ft"),
    ("PRIMER GALLONS",  "17 gallons"),
    ("WALL TOPCOAT",    "17 gallons"),
    ("LABOR HOURS",     "117 hours"),
]

GRAND_TOTAL_LABEL = "QUOTE TOTAL"
GRAND_TOTAL_VALUE = "$10,872"
