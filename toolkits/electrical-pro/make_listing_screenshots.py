...
XLSX_NAME = "Electrical-Pro-Toolkit-v1.xlsx"
TOOLKIT_NAME = "ELECTRICAL PRO TOOLKIT"
TAGLINE = "NEC 220 · Branch circuits · V-drop · Quote"
PRICE = "$39"
...
SHEETS_TO_FEATURE = [
    ...
    ("PANEL-LOAD",      "PANEL-LOAD — NEC 220 service-load calc"),
